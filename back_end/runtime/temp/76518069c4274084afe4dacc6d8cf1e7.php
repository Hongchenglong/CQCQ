<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpstudy_pro\WWW\CQCQ\back_end\public/../application/index\view\menu\menu.html";i:1593744654;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['table', 'treetable'], function () {
        ...
        treetable.render({
            ...
            elem: '#munu-table',
            url: '/cqcq/back_end/public/json/menus.json',
            page: false,
            cols: [[
                {type: 'numbers'},
